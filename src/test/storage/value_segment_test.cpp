...
TEST_F(StorageValueSegmentTest, GetValueInvalidChunkOffset) {
  int_value_segment.append(5.1);
  int_value_segment.append(6);
  int_value_segment.append(7);
  EXPECT_THROW(int_value_segment.operator[](5), std::exception);
}
}  // namespace opossum
